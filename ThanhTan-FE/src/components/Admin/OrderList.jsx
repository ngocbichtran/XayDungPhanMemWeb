...
const OrderList = () => {
    ...
    // Đã cập nhật lại state stats cho khớp với API trả về từ backend
    ...
    // Khi thay đổi bộ lọc tìm kiếm, tự động quay về trang 1
    useEffect(() => {
        setCurrentPage(1);
    }, [statusFilter, searchTerm]);

    // Chạy lại fetch khi đổi trang hoặc đổi bộ lọc
    useEffect(() => {
        fetchOrders();
        fetchStats();
        ...
        try {
            const response = await api.get('/admin/orders', {
                params: {
                    status: statusFilter,
                    search: searchTerm,
                    page: currentPage // Truyền số trang lên Laravel
                }
            });
            
            // Laravel paginate trả về object có chứa 'data' và 'last_page'
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
                <div className="flex flex-col lg:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    {/* === ĐÃ SỬA CHỖ NÀY: THÊM NÚT TẠO ĐƠN HÀNG === */}
