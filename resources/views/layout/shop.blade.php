...
<body class="bg-background-light text-[#111418] transition-colors duration-200">
    <div class="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
        <div class="layout-container flex h-full grow flex-col">
            <!-- Header -->
            <header
                class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f4] px-10 py-3 bg-white sticky top-0 z-50">
                <div class="flex items-center gap-8">
                    ...
                    <label class="flex flex-col min-w-40 !h-10 max-w-64">
                        <div class="flex w-full flex-1 items-stretch rounded-lg h-full">
                            ...
                            <input
                                class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111418] focus:outline-0 focus:ring-0 border-none bg-[#f0f2f4] focus:border-none h-full placeholder:text-[#617589] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal"
                ...
                <div class="flex flex-1 justify-end gap-8">
                    <div class="sptd.php">
                        <a class="text-[#111418] text-sm font-medium leading-normal hover:text-primary transition-colors"
                            href="#">Home</a>
                        <a class="text-[#111418] text-sm font-medium leading-normal hover:text-primary transition-colors"
                            href="#">Categories</a>
                        <a class="text-[#111418] text-sm font-medium leading-normal hover:text-primary transition-colors"
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            class="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-[#f0f2f4] text-[#111418] gap-2 text-sm font-bold leading-normal min-w-0 px-2.5">
            ...
            <main class="flex-1 flex justify-center py-5">
                <div class="layout-content-container flex flex-col max-w-[1280px] w-full px-10 gap-6">
                    ...
                    <div class="@container w-full">
                        <div
                            class="flex flex-col gap-6 px-4 py-8 @[864px]:flex-row bg-white rounded-xl shadow-sm overflow-hidden">
                            ...
                            <div class="flex flex-col gap-6 @[864px]:w-1/2 @[864px]:justify-center px-4 @[864px]:px-10">
                                <div class="flex flex-col gap-2 text-left">
                                    <span class="text-primary font-bold tracking-widest text-sm uppercase">Limited Time
                                        Offer</span>
                                    <h1
                                        class="text-[#111418] text-4xl font-black leading-tight tracking-[-0.033em] @[480px]:text-5xl">
                                        Upgrade Your Lifestyle
                                    </h1>
                                    <p
                                        class="text-[#617589] text-sm font-normal leading-normal @[480px]:text-lg">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <button
                                        class="flex min-w-[140px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-[#f0f2f4] text-[#111418] text-base font-bold leading-normal border border-transparent hover:border-primary/50 transition-all">
                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <aside class="w-full md:w-64 shrink-0">
                            <div
                                class="flex flex-col gap-6 bg-white p-6 rounded-xl shadow-sm sticky top-24">
                                <div class="flex flex-col border-b border-gray-100 pb-4">
                                    <h2 class="text-[#111418] text-lg font-bold leading-normal">Filters
                                    </h2>
                                ...
                                <div class="flex flex-col gap-3">
                                    <p
                                        class="text-sm font-semibold text-[#111418] uppercase tracking-wider">
                                        Categories</p>
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div
                                            class="flex items-center gap-3 px-3 py-2 text-[#111418] hover:bg-gray-100 rounded-lg cursor-pointer transition-colors">
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="flex flex-col gap-6">
                                        <div class="flex h-1 w-full rounded-sm bg-[#dbe0e6] relative">
                                            <div class="absolute left-[10%] right-[30%] h-1 bg-primary"></div>
                                            <div class="absolute left-[10%] -top-1.5 flex flex-col items-center">
                                                <div
                                                    class="size-4 rounded-full bg-primary ring-4 ring-white">
                                                </div>
                                                <p class="text-[#111418] text-[10px] mt-2 font-bold">
                                                    $20</p>
                                            </div>
                                ...
                                <button
                                    class="flex w-full cursor-pointer items-center justify-center rounded-lg h-10 px-4 bg-transparent text-[#617589] text-sm font-medium border border-gray-200 hover:bg-gray-50">
                                    <span>Reset All</span>
                                </button>
                            </div>
                        </aside>
                        ...
                        <div class="flex-1 flex flex-col gap-4">
                            <div class="flex items-center justify-between px-4 pb-3">
                                <h2
                                    class="text-[#111418] text-2xl font-bold leading-tight tracking-[-0.015em]">
                                    Featured Products</h2>
                                <div class="flex items-center gap-2 text-sm text-[#617589]">
                                    <span>Sort by:</span>
                                    <select
                                        class="bg-transparent border-none focus:ring-0 font-bold text-[#111418] py-0">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                <!-- Product Card 1 -->
                                <div
                                    class="flex flex-col bg-white rounded-xl overflow-hidden shadow-sm group hover:shadow-md transition-shadow">
                                    <div class="relative aspect-square bg-center bg-cover"
                                        ...
                                        <div
                                            ...
                                            New</div>
                                        <button
                                            class="absolute top-3 right-3 size-8 flex items-center justify-center bg-white/80 backdrop-blur rounded-full text-[#111418] hover:text-red-500 transition-colors">
                                            <span class="material-symbols-outlined text-xl">favorite</span>
                                        </button>
                                    </div>
                                    <div class="flex flex-col p-4 gap-2">
                                        <div class="flex flex-col">
                                            <p class="text-[#617589] text-xs font-medium uppercase">
                                                Electronics</p>
                                            <h3 class="text-[#111418] text-base font-bold truncate">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span class="text-xs text-[#617589] ml-1">(42)</span>
                                        </div>
                                        <div class="flex items-center justify-between mt-2">
                                            <span
                                                class="text-[#111418] text-xl font-black">$899.00</span>
                                            <button
                                ...
                                <div
                                    ...
                                    <div class="relative aspect-square bg-center bg-cover"
                                        ...
                                        <div
                                            ...
                                            Sale</div>
                                        <button
                                            class="absolute top-3 right-3 size-8 flex items-center justify-center bg-white/80 backdrop-blur rounded-full text-[#111418]">
                                            <span class="material-symbols-outlined text-xl">favorite</span>
                                        </button>
                                    </div>
                                    <div class="flex flex-col p-4 gap-2">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span
                                                class="material-symbols-outlined text-yellow-400 text-sm fill-current">star</span>
                                            <span class="text-xs text-[#617589] ml-1">(128)</span>
                                        </div>
                                        <div class="flex items-center justify-between mt-2">
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-[#111418] text-xl font-black">$45.00</span>
                                                <span
                                                    class="text-[#617589] text-xs line-through">$60.00</span>
                                            </div>
                                            <button
                                                class="flex items-center justify-center size-10 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors">
                                                <span class="material-symbols-outlined">add_shopping_cart</span>
                                    ...
                                    <div class="flex flex-col p-4 gap-2">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span
                                                class="material-symbols-outlined text-yellow-400 text-sm fill-current">star</span>
                                            <span class="material-symbols-outlined text-gray-300 text-sm">star</span>
                                            <span class="text-xs text-[#617589] ml-1">(15)</span>
                                        </div>
                                        <div class="flex items-center justify-between mt-2">
                                            <span
                                                class="text-[#111418] text-xl font-black">$320.00</span>
                                            <button
                                                class="flex items-center justify-center size-10 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors">
                                                <span class="material-symbols-outlined">add_shopping_cart</span>
                                            </button>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col p-4 gap-2">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span
                                                class="material-symbols-outlined text-yellow-400 text-sm fill-current">star</span>
                                            <span class="text-xs text-[#617589] ml-1">(56)</span>
                                        </div>
                                        <div class="flex items-center justify-between mt-2">
                                            <span
                                                class="text-[#111418] text-xl font-black">$249.00</span>
                                            <button
                                                class="flex items-center justify-center size-10 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors">
                                                <span class="material-symbols-outlined">add_shopping_cart</span>
                                            </button>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col p-4 gap-2">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span class="material-symbols-outlined text-gray-300 text-sm">star</span>
                                            <span class="material-symbols-outlined text-gray-300 text-sm">star</span>
                                            <span class="text-xs text-[#617589] ml-1">(89)</span>
                                        </div>
                                        <div class="flex items-center justify-between mt-2">
                                            <span
                                                class="text-[#111418] text-xl font-black">$120.00</span>
                                            <button
                                                class="flex items-center justify-center size-10 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors">
                                                <span class="material-symbols-outlined">add_shopping_cart</span>
                                            </button>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col p-4 gap-2">
                                        <div class="flex flex-col">
                                            <p class="text-[#617589] text-xs font-medium uppercase">
                                                Smart Home</p>
                                            <h3 class="text-[#111418] text-base font-bold truncate">Aura
                                                Smart Speaker</h3>
                                        </div>
                                        <div class="flex items-center gap-1">
                                            <span
                                            ...
                                            <span
                                                class="material-symbols-outlined text-yellow-400 text-sm fill-current">star</span>
                                            <span class="text-xs text-[#617589] ml-1">(210)</span>
                                        </div>
                                        <div class="flex items-center justify-between mt-2">
                                            <span
                                                class="text-[#111418] text-xl font-black">$79.99</span>
                                            <button
                                                class="flex items-center justify-center size-10 rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors">
                                                <span class="material-symbols-outlined">add_shopping_cart</span>
                                            </button>
                            ...
                            <div class="flex items-center justify-center gap-2 py-8 mt-4">
                                <button
                                    class="size-10 flex items-center justify-center rounded-lg border border-gray-200 text-[#617589] hover:bg-gray-50 transition-colors">
                                    <span class="material-symbols-outlined">chevron_left</span>
                                </button>
                                <button
                                    class="size-10 flex items-center justify-center rounded-lg bg-primary text-white font-bold">1</button>
                                <button
                                    class="size-10 flex items-center justify-center rounded-lg text-[#111418] hover:bg-gray-100 font-medium">2</button>
                                <button
                                    class="size-10 flex items-center justify-center rounded-lg text-[#111418] hover:bg-gray-100 font-medium">3</button>
                                <span class="px-2 text-gray-400">...</span>
                                <button
                                    class="size-10 flex items-center justify-center rounded-lg text-[#111418] hover:bg-gray-100 font-medium">12</button>
                                <button
                                    class="size-10 flex items-center justify-center rounded-lg border border-gray-200 text-[#617589] hover:bg-gray-50 transition-colors">
            ...
            <!-- Footer -->
            <footer class="bg-white border-t border-gray-100 pt-16 pb-8 px-10">
                <div class="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center gap-2 text-primary">
                            <span class="material-symbols-outlined text-3xl">shopping_bag</span>
                            <h2 class="text-[#111418] text-xl font-bold">UserStore</h2>
                        </div>
                        <p class="text-[#617589] text-sm">The world's fastest growing e-commerce
                            marketplace with thousands of high quality products.</p>
                    </div>
                    <div class="flex flex-col gap-4">
                        <h4 class="text-[#111418] font-bold">Shop</h4>
                        <ul class="flex flex-col gap-2 text-[#617589] text-sm">
                    ...
                    <div class="flex flex-col gap-4">
                        <h4 class="text-[#111418] font-bold">Company</h4>
                        <ul class="flex flex-col gap-2 text-[#617589] text-sm">
                    ...
                    <div class="flex flex-col gap-4">
                        <h4 class="text-[#111418] font-bold">Newsletter</h4>
                        <p class="text-[#617589] text-sm">Subscribe to get updates on new products
                            and special offers.</p>
                        <div class="flex gap-2">
                            <input
                                class="flex-1 bg-[#f0f2f4] border-none rounded-lg px-4 h-10 text-sm focus:ring-primary"
                ...
                <div
                    class="max-w-[1280px] mx-auto pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-[#617589] text-xs">© 2024 UserStore. All rights reserved.</p>
